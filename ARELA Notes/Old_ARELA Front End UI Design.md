...
* **Items:**
    1.  **Market Recon:** Search for markets. (Growing/Hot Markets=Fix and Flip, High Rent/Price=Buy and Hold, Etc.)
    2.  **Lead Scout (Map):** Search for leads. The default view.
    3.  **Property Sniper (CRM):** Leads you have saved/favorited.
    4.  **Contacts:** List of owners you are engaging.
    5.  **Campaigns:** SMS/Voice marketing stats.
    6.  **Analytics:** "The Watchtower" metrics (API costs, success rates).
    7.  **Settings:** API Keys, Team Management.
...
1.  User goes to "Property Sniper" -> "Tucson Vacants" list.
2.  Selects 10 leads.
