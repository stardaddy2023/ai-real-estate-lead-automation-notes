...
def inspect_parcel():
    # Pima County GIS Layer 12 (Parcels)
    ...
    try:
        ...
        if resp.status_code == 200:
            ...
            if features:
                ...
                print("\n--- Raw Attributes for Parcel 117023950 ---")
                ...
                for k, v in attr.items():
                    if str(v) == "2177" or str(v) == "2177.0":
                        ...
                        found = True
                if not found:
                    print("Value 2177 NOT FOUND in Layer 12 attributes.")
            else:
                print("No features found for this parcel.")
        else:
