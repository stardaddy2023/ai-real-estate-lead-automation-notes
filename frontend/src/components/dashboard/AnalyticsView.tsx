...
const chartData = [
    { month: "January", leads: 186, offers: 80 },
    { month: "February", leads: 305, offers: 200 },
    { month: "March", leads: 237, offers: 120 },
    { month: "April", leads: 73, offers: 190 },
    { month: "May", leads: 209, offers: 130 },
    { month: "June", leads: 214, offers: 140 },
]
            ...
            <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
                ...
                <Card>
                    ...
                    <CardContent>
                        ...
                        <p className="text-xs text-muted-foreground">Currently in negotiation</p>
                    </CardContent>
                </Card>
                <Card>
                    <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
